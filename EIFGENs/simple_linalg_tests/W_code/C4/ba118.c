...
extern EIF_TYPED_VALUE F118_1640(EIF_REFERENCE);
extern EIF_TYPED_VALUE F118_1641(EIF_REFERENCE);
...
EIF_TYPED_VALUE F118_1640 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 117, Current, 0, 0, 1630);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1611, 135))(Current)).it_i4);
...
RTOID (F118_1641)
EIF_TYPED_VALUE F118_1641 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 117, Current, 0, 0, 1631);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
