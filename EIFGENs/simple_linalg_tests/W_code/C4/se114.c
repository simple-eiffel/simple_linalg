...
extern EIF_TYPED_VALUE F114_1630(EIF_REFERENCE);
...
EIF_TYPED_VALUE F114_1630 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 113, Current, 0, 0, 1620);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(113, Current, 1620);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1633, 135))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 113, Current, 0, 0, 1621);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(113, Current, 1621);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
