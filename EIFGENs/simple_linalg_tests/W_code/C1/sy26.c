...
extern void F26_7084(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F26_585 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 25, Current, 0, 0, 554);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(25, Current, 554);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F26_7084 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 25, Current, 0, 7083);
	RTSA(Dtype(Current));
