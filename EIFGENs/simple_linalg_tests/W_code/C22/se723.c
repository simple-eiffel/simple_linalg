...
extern EIF_TYPED_VALUE F723_3614(EIF_REFERENCE);
...
EIF_TYPED_VALUE F723_3614 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 722, Current, 0, 0, 4949);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(722, Current, 4949);
	RTIV(Current, RTAL);
	RTHOOK(1);
