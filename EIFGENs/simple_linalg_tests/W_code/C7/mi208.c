...
extern void F208_4505(EIF_REFERENCE);
extern EIF_TYPED_VALUE F208_4506(EIF_REFERENCE);
...
void F208_4505 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 207, Current, 2, 0, 8922);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(207, Current, 8922);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F208_4506)
EIF_TYPED_VALUE F208_4506 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 207, Current, 0, 0, 8923);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(207, Current, 8923);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
