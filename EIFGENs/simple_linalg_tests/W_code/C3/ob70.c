...
extern EIF_TYPED_VALUE F70_1335(EIF_REFERENCE);
...
EIF_TYPED_VALUE F70_1335 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 69, Current, 0, 0, 1336);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(69, Current, 1336);
	RTIV(Current, RTAL);
	RTHOOK(1);
